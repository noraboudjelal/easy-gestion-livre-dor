...
const THEMES = {
  ...
  "Anniversaire": {
    ink: "#B85C7A",
    surface: "rgba(255,249,247,0.90)",
    surface2: "#F3DDE2",
    accent: "#D8B56A",
    accentSoft: "rgba(216,181,106,0.24)",
    accentText: "#38242E",
    ivory: "#38242E",
    muted: "#50303F",
    textAccent: "#50303F",
    actionBackground: "#754357",
    actionText: "#FFF9F7",
    button: "#754357",
    borderColor: "#D8B56A",
    avatarPalette: ["#B85C7A", "#92704F", "#826774", "#9C546E"],
    pageGradient: "linear-gradient(135deg, #B85C7A 0%, #D995A8 100%)",
    contentGradient: "linear-gradient(160deg, #B85C7A 0%, #D995A8 100%)",
    headerGradient: "linear-gradient(120deg, #D995A8 0%, #E7B9C6 52%, #F3DDE2 100%)",
    cardGradient: "linear-gradient(135deg, rgba(217,149,168,0.94) 0%, rgba(231,185,198,0.94) 48%, rgba(250,235,238,0.96) 100%)",
  },
  "Baby Shower": {
    ink: "linear-gradient(135deg, #B7E4FF 0%, #F5B2CF 100%)",
    surface: "#DDF2FF",
    surface2: "#FFD2E4",
    accent: "#E36F9F",
    accentSoft: "rgba(227,111,159,0.3)",
    accentText: "#30445F",
    ivory: "#30445F",
    muted: "#58778F",
    borderColor: "#79BFE8",
    cardGradient: "linear-gradient(145deg, #BFE8FF 0%, #FFD0E3 66%, #FFFFFF 100%)",
    button: "#579FD0",
    ...
    <div className="event-shell" style={styles.page}>
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .event-header-card { position: sticky; top: 0; z-index: 50; margin: 0 -26px 18px !important; padding: 14px 26px 12px !important; background: ${theme.headerGradient || theme.surface} !important; backdrop-filter: blur(14px); border-bottom: 1px solid ${theme.borderColor || theme.accentSoft}; box-shadow: 0 5px 18px rgba(0,0,0,.08) !important; }
