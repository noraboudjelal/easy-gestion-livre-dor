...
const THEMES = {
  ...
  "Anniversaire": {
    ...
    pageGradient: "linear-gradient(135deg, #241220 0%, #492039 58%, #603249 100%)",
    headerGradient: "linear-gradient(120deg, #241220 0%, #492039 100%)",
    cardGradient: "linear-gradient(145deg, #603249 0%, #492039 48%, #241220 100%)",
  },
  "Baby Shower": {
