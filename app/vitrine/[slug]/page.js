      ...
      <div className="wrap">
        ...
        <section className="section" id="portfolio">
          ...
          {visible.length ? <div className="portfolio-list">{visible.map(r => {
            ...
            return <article className="portfolio-card" key={`${active}-${r.id}`}>
              ...
              <div className="portfolio-caption">{r.category && <span className="portfolio-category">{r.category}</span>}{r.name && <strong>{r.name}</strong>}{r.price != null && r.price !== "" && <span className="portfolio-price">{r.price}</span>}</div>
